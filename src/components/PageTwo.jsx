...
const PageTwo = () => {
  return (
    <div name='about' className="w-full mt-10 px-10 mt-14">
      ...
      <div className="md:flex">
        <div className="w-full md:w-6/12 md:mt-14">
          <p className="text-2xl font-semibold uppercase md:text-4xl md:w-[85%]">
            Es gibt 1000 Augmented RealitY Entwickler Auf der Welt.
          </p>
          <p className="text-2xl font-semibold uppercase mt-2 md:mt-14">
            wir sind Anders.{" "}
          </p>
          <p className="text-sm mt-2 md:text-lg lg:text-xl md:text-xl md:mt-14 md:w-[85%]">
          ...
          <p className="text-sm mt-2 md:text-lg lg:text-xl md:mt-14 md:w-[85%]">
      ...
      <h1 name='produkte' className="text-5xl text-gray-600 font-semibold md:font-bold uppercase">Produkte</h1>
